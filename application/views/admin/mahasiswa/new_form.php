      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <?php echo form_open_multipart('admin/DataMahasiswa/add'); ?>

              <div class="form-group">
                <label for="id">Id Mahasiswa</label>
                <input class="form-control <?php echo form_error('id') ? 'is-invalid' : '' ?>" type="text" name="id" placeholder="Id mahasiswa" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nama_mahasiswa') ? 'is-invalid' : '' ?>" type="text" name="nama_mahasiswa" placeholder="Nama mahasiswa" />
                <div class="invalid-feedback">
